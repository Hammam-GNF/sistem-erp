...
<script>
    ...
    $(document).ready(function() {
        ...
        //Handle add form
        $('#create-payment, #edit-payment').submit(function(e) {
            e.preventDefault();
            let form = $(this);
            let isEdit = form.attr('id') === 'edit-payment';
            let url = isEdit ? `/payment/${$('#edit_id').val()}` : "{{ route('payment.store') }}";
