...
<script>
    ...
    $(document).ready(function() {
        ...
        //Handle add form
        $('#create-supplier, #edit-supplier').submit(function(e) {
            e.preventDefault();
            let form = $(this);
            let isEdit = form.attr('id') === 'edit-supplier';
            let url = isEdit ? `/supplier/${$('#edit_id').val()}` : "{{ route('supplier.store') }}";
        ...
        //     let id = $('#edit_id').val();
        //     let formData = new FormData(document.getElementById('edit-supplier'));
